    ...
    <div className={styles.layout}>
      ...
      <article className={styles.manual}>
        ...
        <section id="syllabus" className={styles.section}><Chapter number="04" label="Learning roadmap" title="Syllabus" lead="Browse your AI-built curriculum, learn subtopics out of order and keep those completions ready for their scheduled day."/>
          ...
          <FeatureGrid items={[["Personal roadmap","Eight progressive modules and forty subtopics are tailored to the selected outcome and experience level."],["Search and filter","Search across module names and individual subtopics; review module completion percentages."],["Verified direct resources","DS95 searches GeeksforGeeks first, then Kaggle Learn, official documentation, freeCodeCamp, MDN, Microsoft Learn, Google Developers, universities, government guides and focused YouTube lessons. Search pages and unverified URLs are rejected."],["AI lesson fallback","When no suitable direct source is verified, DS95 provides an expandable AI study guide with a summary, key ideas, example and practice task."],["Manual completion","Select the numbered control beside any subtopic to mark it complete; select again to reopen it."],["Future-day awareness","Early completions remain stored and automatically appear complete when that subtopic becomes Today’s work."]]}/>
        </section>
